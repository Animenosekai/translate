"""
translatepy's implementation of plugins
"""
import typing
...
class PluginsException(BaseTranslateException):
    error_codes = {
        429: "Too many requests" # add your own status codes and error
    }

    # you can use it like so in your endpoint:
    # raise PluginsException(request.status_code)

class Plugins(BaseTranslator):
    """
    translatepy's implementation of plugins
    """
