...
| ------------ | -------------------------------- | ---------------- | ---------------- |
| `lang` | The language to lookup  | Oui            | str            |
| `threshold` | The similarity threshold to use when searching for similar languages  | Non            | float            |
...
| ------------ | -------------------------------- | ---------------- | ---------------- |
| `lang` | The language to lookup  | Oui            | str            |
| `limit` | The limit of languages to return. (max: 100, default: 10)  | Non            | int            |
| `foreign` | Whether to include the language in foreign languages  | Non            | Bool            |
...
| Nom         | Description                      | Obligatoire         | Type             |
| ------------ | -------------------------------- | ---------------- | ---------------- |
| `language` | The language to lookup  | Oui            | str            |
