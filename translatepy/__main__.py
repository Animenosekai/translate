...
def entry():
    ...
    def prepare_json_parser(parser: argparse.ArgumentParser):
        parser.add_argument("--minifed", action="store_true", help="To minify the resulting JSON")
    ...
    parser_translate_html.add_argument('--html', '--text', '-t', action='store', type=str, required=True, help='text to translate')
    ...
    parser_example.add_argument('--text', '-t', action='store', type=str, required=True, help='text to get examples of')
    ...
    parser_dictionary.add_argument('--text', '-t', action='store', type=str, required=True, help='text to get meanings of')
    ...
    parser_tts.add_argument('--text', '-t', action='store', type=str, required=True, help='text to get synthesis of')
    ...
    if args.action == 'translate-html':
        return apply("translate-html", text=args.html, dest_lang=args.dest_lang, source_lang=args.source_lang,
