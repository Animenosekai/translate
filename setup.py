...
setup(
    ...
    download_url = "https://github.com/Animenosekai/translate/archive/v2.0.0.tar.gz",
    ...
    install_requires = ['requests', 'beautifulsoup4', 'typing; python_version<"3.5"', 'pyuseragents'],
